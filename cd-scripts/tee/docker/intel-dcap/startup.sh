...
export PYTHONPATH=$PYTHONPATH:/builder/gramine/lib/python3.11/site-packages/
export PATH=$PATH:/builder/gramine/bin:/builder/.cargo/bin
export PKG_CONFIG_PATH=$PKG_CONFIG_PATH:/builder/gramine/lib/x86_64-linux-gnu/pkgconfig/

cd /linux-sgx && make deb_psw_pkg
cp /builder/sgx_default_qcnl.conf /etc/sgx_default_qcnl.conf
