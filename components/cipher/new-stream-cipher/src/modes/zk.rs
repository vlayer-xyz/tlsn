...
#[async_trait]
impl<C, E> ZkStreamCipher<C> for ZkCipher<C, E>
where
    C: CtrCircuit,
    E: Thread + Execute + Load + Prove + Verify + Decode + DecodePrivate + Send + Sync + 'static,
{
